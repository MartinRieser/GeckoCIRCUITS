...
import ch.technokrat.gecko.geckocircuits.control.javablock.ControlJavaTriangles;
 ...
 * @author andreas
 */
public final class ControlNativeC extends ControlBlock implements VariableTerminalNumber {

    public static final ControlTypeInfo tinfo = new ControlTypeInfo(ControlNativeC.class, "C DLL", I18nKeys.C_DLL);

    private final ControlJavaTriangles _inputTri = new ControlJavaTriangles();
    private final ControlJavaTriangles _outputTri = new ControlJavaTriangles();
    ...
    public void drawBlockRectangle(final Graphics2D graphics) {
        ...
        final int delta = THREE;  // // Distance from the red triangle to the SCOPE block (up or down)
    ...
    protected final Window openDialogWindow() {         
            // // everything OK, 'tools.jar' is present and the JAVA block can be started correctly
