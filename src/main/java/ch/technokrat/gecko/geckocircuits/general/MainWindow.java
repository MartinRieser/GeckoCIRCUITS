...
public final class MainWindow extends JFrame implements WindowListener, ActionListener, ComponentListener {
    ...
    public boolean saveZVData(String stringID_scope, String fileName) {
        List<ControlBlock> eC = _se.getElementCONTROL();
        for (ControlBlock ec : eC) {
    ...
    public MainWindow() {
        ...
        sea.registerSchematicEditor(_se);
        buildGUI();
    ...
    private void processKeyEvents(KeyEvent ke) {
        ...
        if (ke.getKeyChar() == 'w' || ((int) ke.getKeyChar()) == 23) {
            _se.mouseToggleSelectModeWireModeConnectorTestMode();
    ...
    public void createNewFile() {
        ...
        MainWindow.currentFileName = UNTITLED;
        this.setTitle(currentFileName + spTitleX + "GeckoCIRCUITS");
    ...
    public void openFile(BufferedReader in) throws IOException {
        ...
        _se.loadSavedNetlistFromProjectData(daten, null);
    ...
    public void openFile(String dateiName) throws FileNotFoundException {
        ...
        // static ControlFromExternal and ControlToExtral ArrayLists, the simulink
    ...
    public static void importComponentsFromFile(final String fileName, final String importIntoSubCircuitName) throws FileNotFoundException {
        ...
        _se.loadSavedNetlistFromProjectData(daten, importIntoSubCircuitName);
