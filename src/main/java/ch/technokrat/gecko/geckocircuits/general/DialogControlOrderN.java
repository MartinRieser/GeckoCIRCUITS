...
public class DialogControlOrderN extends javax.swing.JDialog implements DragGestureListener, DragSourceListener, DropTargetListener{
    ...
    public DialogControlOrderN(final java.awt.Frame parent, final boolean modal, final List<ControlBlock> optimizedList) {
    ...
    private void initButtonEvents(){
        ...
        jButtonOK.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(final ActionEvent event){
                ...
                final List<ControlBlock> userList = new ArrayList<ControlBlock>();
        ...
        jButtonReset.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(final ActionEvent event){
                ...
                final DefaultListModel<ControlBlock> userModel = new DefaultListModel<>();
    ...
    private void initLists(final List<ControlBlock> optimizedList){
        final DefaultListModel<ControlBlock> optModel = new DefaultListModel<>();
        final DefaultListModel<ControlBlock> userModel = new DefaultListModel<>();
        for(ControlBlock regelblock : optimizedList){
...
//    }
    ...
    private javax.swing.JList<ControlBlock> jListOptimized;
    private javax.swing.JList<ControlBlock> jListUser;
    ...
    public final void drop(final DropTargetDropEvent dtde) {
        ...
        final DefaultListModel<ControlBlock> model = (DefaultListModel<ControlBlock>) jListUser.getModel();
        model.remove(_sourceIndex);
        if (index < _sourceIndex){
            model.add(index, (ControlBlock) _draggedObject);
        } else {
            model.add(index-1, (ControlBlock) _draggedObject);
        }
