...
public class GlobalColors {
    ...
    public static Color farbeTextLinie = Color.lightGray;  // // Connection line from the text field to the associated element
    public static Color farbeInBearbeitungLK = Color.gray;
    public static Color farbeFertigElementLK = Color.decode("0x00008b");
    public static Color farbeFertigConnectionLK = Color.blue;
    public static Color farbeLabelLK = Color.decode("0x00008b");
    public static Color farbeParallelLK = Color.decode("0xadd8e6");  // // if a parallel line is drawn in Connection.draw() for better visualization
    ...
    public static Color farbeFertigConnectionCONTROL = Color.green;
    ...
    public static Color farbeFertigConnectionTHERM = Color.red;
