...
/**
 * Factor out all type path information here.
 *
 * @todo Clean this up -> Merged with Andy's get rid of the variables etc.
 * @todo _unsaved belongs in Style.
 * @todo Maybe we want different stuff for default and current fname?
 * @todo I suspect _undefined should be gotten rid of when time allows.
 *
 * WARNING: Someone told me that it would also be possible to get the jarpath
