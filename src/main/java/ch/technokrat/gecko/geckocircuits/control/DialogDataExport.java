...
import ch.technokrat.gecko.geckocircuits.control.ControlSaveData.OutputType;
...
public final class DialogDataExport extends javax.swing.JDialog {
    ...
    public DialogDataExport(final java.awt.Frame parent, final boolean modal, final ControlSaveData dataSavable,
        ...
        jTextArea1.setText(MainWindow.getOpenFileName().replace(".ipes", "CISPR.txt"));
    ...
    private void jButtonTableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTableActionPerformed
        DataTableFrame dtf = new DataTableFrame(NetlistControl.globalData, this);
        dtf.setVisible(true);
