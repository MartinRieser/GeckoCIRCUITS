...
public abstract class ControlBlock extends AbstractBlockInterface {
    ...
    protected ControlBlock(final int noInputs, final int noOutputs) {                
    ...
    // // for overwriting PI blocks and similar:
    ...
    public final void setTyp(final ControlComponentType controTyp) {
    ...
    ControlComponentType getControlComponentType() {
        return _controlTyp;
    }
    ...
    void setInputSignal(final int inputIndex, final ControlBlock outputBlock, final int outputIndex) {
        try {                                    
        ...
        useExternal.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent actionEvent) {
                if (useExternal.getValue()) {
                    ((ControlInputTwoTerminalStateable) ControlBlock.this).setExpanded();
                } else {
                    ((ControlInputTwoTerminalStateable) ControlBlock.this).setFolded();                    
                }
            }
        });
    }                    
