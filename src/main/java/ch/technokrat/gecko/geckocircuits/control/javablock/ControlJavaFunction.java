...
public final class ControlJavaFunction extends ControlBlock implements VariableTerminalNumber, SpecialNameVisible,
    ...
    protected final Window openDialogWindow() {
        if (GeckoSim.compiler_toolsjar_missing) {
            ...
            // // a 'dummy' block was therefore started and a warning dialog is shown here -->
