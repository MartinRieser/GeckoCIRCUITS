...
public final class ControlCISPR16 extends ControlBlock implements SpecialNameVisible,
    ...
    private class CisprCalculator extends AbstractControlCalculatable implements MemoryInitializable {
        ...
        public void doInit(final double deltaT) {
            try {
                _zvDatenRam = DataContainerSimple.fabricConstantDtTimeSeries(1, (int) ((SimulationKernel.tEND - SimulationKernel.tSTART) / deltaT)
                        + DATA_INDEX_ADD);
    ...
    public void drawBlockRectangle(final Graphics2D graphics) {
        ...
        // // Base points of the Class A/B curves:
