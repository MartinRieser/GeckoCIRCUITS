...
/**
 * Extended control input terminal that displays a magenta label alongside the regular label.
 * Used to show additional type or connection information on the circuit sheet.
 */
