...
public final class ControlFromEXTERNAL extends ControlBlockSimulink implements VariableTerminalNumber {
        ...
        if (StartupWindow.testDialogOpenSourceVersion("Simulink interface")) {
            ...
            return new AbstractControlCalculatable(0, _terminalNumber) {
                ...
                public void calculateYOUT(final double deltaT) {
                    // // 'parameter[]' must be written with the current signal values ​​by the external program
    ...
    public void drawBlockRectangle(final Graphics2D graphics) {
        ...
        graphics.drawLine((int) (dpix * (xPos - 0.4)), (int) (dpix * pfym), (int) (dpix * (xPos - pf)), (int) (dpix * pfym));  // // belonging to the arrow
