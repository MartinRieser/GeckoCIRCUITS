...
/**
 * Frame displaying the Fourier analysis plot panel.
 * @author andy
 */
public class FourierPlotFrame extends javax.swing.JFrame {    
    ...
    /**
     * Constructs the Fourier plot frame.
     * @param newScope the scope instance for registering additional panels
     * @param baseFrequency the fundamental frequency
     * @param erg the Fourier results array [an/bn/cn/jn][signals][harmonics]
     */
    ...
    /**
     * NetBeans Form Editor-generated code for GUI initialization.
    ...
    /** Generated panel for Fourier plot display. */
    private ch.technokrat.gecko.geckocircuits.newscope.JPanelFourier jPanelFourier1;
    /** Generated toolbar for Fourier frame actions. */
