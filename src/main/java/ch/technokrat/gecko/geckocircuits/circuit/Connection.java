...
public class Connection extends AbstractCircuitSheetComponent implements ComponentTerminable, Labable {
    ...
    public final void absetzenElement() {          
        if(_isInitialized) {
            MoveConnectionUndoAction undoAction = new MoveConnectionUndoAction(_pointsBeforeMove, _connectorPoints);            
    ...
    public final void setCurrentPointOnConnection(final Point point) {
        ...
        } else {    // // first part of the line along y-axis (vertical)
    ...
    public final void paintGeckoComponent(final Graphics2D graphics) {        
        ...
        switch (_connectorType) {
            case RELUCTANCE:
                ...
                break;
            case LK:
                fFertig = GlobalColors.farbeFertigConnectionLK;
                break;
            case CONTROL:
                fFertig = GlobalColors.farbeFertigConnectionCONTROL;
                break;
            case THERMAL:
                fFertig = GlobalColors.farbeFertigConnectionTHERM;
                break;
            case NONE:
                fFertig = Color.gray;
                break;
    ...
    private class MoveConnectionUndoAction implements UndoableEdit {
        ...
        private MoveConnectionUndoAction(final List<Point> oldPositions, final List<Point> newPositions) {
