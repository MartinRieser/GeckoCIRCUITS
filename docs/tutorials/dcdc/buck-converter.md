...
[:material-download: Buck Converter Circuit (buck_simple.ipes)](https://github.com/MartinRieser/GeckoCIRCUITS/blob/main/resources/tutorials/2xx_dcdc_converters/201_buck_converter/buck_simple.ipes){ .md-button }
