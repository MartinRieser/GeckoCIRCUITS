...
**Commit:** [d69f9f5a](https://github.com/MartinRieser/GeckoCIRCUITS/commit/d69f9f5a)
...
=== "Windows"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.12.0/GeckoCIRCUITS-2.12.0-windows.zip
...
=== "Linux"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.12.0/GeckoCIRCUITS-2.12.0-linux.zip
...
=== "macOS"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.12.0/GeckoCIRCUITS-2.12.0-macos.zip
...
=== "WSL"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.12.0/GeckoCIRCUITS-2.12.0-wsl.zip
...
[View all changes](https://github.com/MartinRieser/GeckoCIRCUITS/compare/v2.11.0...v2.12.0)

---

## Links

- [GitHub Release](https://github.com/MartinRieser/GeckoCIRCUITS/releases/tag/v2.12.0)
- [All Releases](https://github.com/MartinRieser/GeckoCIRCUITS/releases)
- [Source Code](https://github.com/MartinRieser/GeckoCIRCUITS/tree/v2.12.0)
