...
**Commit:** [7a81b5ce](https://github.com/MartinRieser/GeckoCIRCUITS/commit/7a81b5ce)
...
=== "Windows"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.13.0/GeckoCIRCUITS-2.13.0-windows.zip
...
=== "Linux"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.13.0/GeckoCIRCUITS-2.13.0-linux.zip
...
=== "macOS"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.13.0/GeckoCIRCUITS-2.13.0-macos.zip
...
=== "WSL"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.13.0/GeckoCIRCUITS-2.13.0-wsl.zip
...
[View all changes](https://github.com/MartinRieser/GeckoCIRCUITS/compare/v2.12.0...v2.13.0)
...
- [GitHub Release](https://github.com/MartinRieser/GeckoCIRCUITS/releases/tag/v2.13.0)
- [All Releases](https://github.com/MartinRieser/GeckoCIRCUITS/releases)
- [Source Code](https://github.com/MartinRieser/GeckoCIRCUITS/tree/v2.13.0)
