...
**Commit:** [f830c95f](https://github.com/MartinRieser/GeckoCIRCUITS/commit/f830c95f)
...
=== "Windows"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.11.0/GeckoCIRCUITS-2.11.0-windows.zip
...
=== "Linux"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.11.0/GeckoCIRCUITS-2.11.0-linux.zip
...
=== "macOS"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.11.0/GeckoCIRCUITS-2.11.0-macos.zip
...
=== "WSL"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.11.0/GeckoCIRCUITS-2.11.0-wsl.zip
...
[View all changes](https://github.com/MartinRieser/GeckoCIRCUITS/compare/v2.10.0...v2.11.0)
...
- [GitHub Release](https://github.com/MartinRieser/GeckoCIRCUITS/releases/tag/v2.11.0)
- [All Releases](https://github.com/MartinRieser/GeckoCIRCUITS/releases)
- [Source Code](https://github.com/MartinRieser/GeckoCIRCUITS/tree/v2.11.0)
