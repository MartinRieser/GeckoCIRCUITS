...
**Commit:** [ab5f214a](https://github.com/MartinRieser/GeckoCIRCUITS/commit/ab5f214a)
...
=== "Windows"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.15.0/GeckoCIRCUITS-2.15.0-windows.zip
...
=== "Linux"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.15.0/GeckoCIRCUITS-2.15.0-linux.zip
...
=== "macOS"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.15.0/GeckoCIRCUITS-2.15.0-macos.zip
...
=== "WSL"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.15.0/GeckoCIRCUITS-2.15.0-wsl.zip
...
[View all changes](https://github.com/MartinRieser/GeckoCIRCUITS/compare/v2.14.0...v2.15.0)
...
- [GitHub Release](https://github.com/MartinRieser/GeckoCIRCUITS/releases/tag/v2.15.0)
- [All Releases](https://github.com/MartinRieser/GeckoCIRCUITS/releases)
- [Source Code](https://github.com/MartinRieser/GeckoCIRCUITS/tree/v2.15.0)
