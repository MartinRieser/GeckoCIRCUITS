...
**Commit:** [fd484fe1](https://github.com/MartinRieser/GeckoCIRCUITS/commit/fd484fe1)
...
=== "Windows"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.10.0/GeckoCIRCUITS-2.10.0-windows.zip
...
=== "Linux"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.10.0/GeckoCIRCUITS-2.10.0-linux.zip
...
=== "macOS"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.10.0/GeckoCIRCUITS-2.10.0-macos.zip
...
=== "WSL"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.10.0/GeckoCIRCUITS-2.10.0-wsl.zip
...
- [GitHub Release](https://github.com/MartinRieser/GeckoCIRCUITS/releases/tag/v2.10.0)
- [All Releases](https://github.com/MartinRieser/GeckoCIRCUITS/releases)
- [Source Code](https://github.com/MartinRieser/GeckoCIRCUITS/tree/v2.10.0)
