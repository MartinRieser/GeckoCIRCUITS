...
**Commit:** [6db364f1](https://github.com/MartinRieser/GeckoCIRCUITS/commit/6db364f1)
...
=== "Windows"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.17.0/GeckoCIRCUITS-2.17.0-windows.zip
...
=== "Linux"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.17.0/GeckoCIRCUITS-2.17.0-linux.zip
...
=== "macOS"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.17.0/GeckoCIRCUITS-2.17.0-macos.zip
...
=== "WSL"
    ...
    ```bash
    # Download
    wget https://github.com/MartinRieser/GeckoCIRCUITS/releases/download/v2.17.0/GeckoCIRCUITS-2.17.0-wsl.zip
...
[View all changes](https://github.com/MartinRieser/GeckoCIRCUITS/compare/v2.16.0...v2.17.0)
...
- [GitHub Release](https://github.com/MartinRieser/GeckoCIRCUITS/releases/tag/v2.17.0)
- [All Releases](https://github.com/MartinRieser/GeckoCIRCUITS/releases)
- [Source Code](https://github.com/MartinRieser/GeckoCIRCUITS/tree/v2.17.0)
